 ...
 * <li>Score: Nodes that will be connected</li>
 * <li>Selection: at random from the restricted candidate list</li>
 * </ul>
 *
 * @author juandavid
 */
public class ConstructiveC2 implements Constructive<RLPInstance, RLPSolution> {
    ...
    public ConstructiveC2(float alpha) {
...
//        System.out.println("Candidate List (solucion): " + candidateList.toString());
    ...
    private void updateCandidateList(int nextNode, Candidate[] arrayCandidates, ArrayList<Candidate> listCandidates) {
        boolean firstRegenerator = !connected[nextNode];
        if(firstRegenerator){
    ...
    public String toString(){
        ...
        return String.format("C2(alpha=%s)", param);
    }
