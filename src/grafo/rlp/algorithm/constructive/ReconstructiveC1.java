...
/**
 * Algoritmo Greedy. (Note: This class was 'forked' from ConstructiveC1 to allow the
...
public class ReconstructiveC1 implements Constructive<RLPInstance, RLPSolution>, RLPReconstructive {
    ...
    public ReconstructiveC1(float alpha, float deterioration_factor) {
    ...
    public RLPSolution constructSolution(RLPInstance instance) {
        ...
        this.alpha = Float.isNaN(parameter_alpha) ? random.nextFloat() : alpha;
    ...
    public RLPSolution reconstructSolution(RLPInstance instance, List<Integer> selected, Set<Integer> excludedCandidates) {
        ...
        //candidateList = reconstructCandidateList(excludedCandidates); //not necesary at this point...
...
//        System.out.println("Reconstruida : " + solution.getRegeneratorAsList());
    ...
    private void reconstructPartialSolution(List<Integer> selected, Set<Integer> excludedCandidates) {
        ...
        selected.forEach(c -> connected[c]=true);
        connectedNodes = selected.size();
        ...
        for (Integer s : selected) {
            ...
            updateCandidateList(s, candidateByIndex, candidateList, excludedCandidates);
        }
    }
    ...
    private int selectRandomCandidateRCL() {
        ...
        //TODO:
//        int threshold = (int) (max - alpha * (max - min));
    ...
    public String toString() {
        ...
        return String.format("RC1(alpha=%s)", param);
    }
